...
# st.set_page_config(
#     page_title="Style recommendation demo",
#     page_icon="",
#     layout="wide"
# )
...
# with ct_1:
#     st.title("Search query items")
#     st.header("")
#     target_category = st.text_input("Search items with categories.")
#     st.write('{} selected'.format(target_category))
import streamlit as st
